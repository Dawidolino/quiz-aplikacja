...
private String selectedOptionByUser = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String getSelectedTopicName = getIntent().getStringExtra("wybranyTemat");
...
private void changeNextQuestion(){
        ...
        if(currentQuestionPostion<questionsLists.size()){
            ...
            intent.putExtra("prawidlowo",getCorrectAnswer());
            intent.putExtra("nieprawidlowo",getIncorrectAnswer());
